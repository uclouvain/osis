...
def format_version_complete_name(node: 'NodeGroupYear', language: str) -> str:
    ...
    if language == LANGUAGE_CODE_EN:
        return " - {}{}".format(node.version_title_en if node.version_title_en else "", version_name)
    return " - {}{}".format(node.version_title_fr if node.version_title_fr else "", version_name)
