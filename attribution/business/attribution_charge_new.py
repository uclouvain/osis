...
def find_attribution_charge_new(learning_unit_year):
    return attribution_charge_new.AttributionChargeNew.objects_attributions \
...
def find_attributions_with_charges(learning_unit_year_id):
    lecturing_charges = AttributionChargeNew.objects_attributions \
    ...
    practical_charges = AttributionChargeNew.objects_attributions \
    ...
    attributions = AttributionNew.objects_attributions \
