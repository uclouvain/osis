...
urlpatterns = [
    ...
    url(r'^allocation_entity_autocomplete/$', base.views.learning_units.update.AllocationEntityAutocomplete.as_view(),
        name='allocation_entity_autocomplete'),
    url(r'^additionnal_entity_1_autocomplete/$', base.views.learning_units.update.AdditionnalEntity1Autocomplete.as_view(),
        name='additionnal_entity_1_autocomplete'),
    url(r'^additionnal_entity_2_autocomplete/$', base.views.learning_units.update.AdditionnalEntity2Autocomplete.as_view(),
        name='additionnal_entity_2_autocomplete'),
