...
urlpatterns = [
    ...
    url(r'^additional_entity_1_autocomplete/$', base.views.learning_units.update.AdditionnalEntity1Autocomplete.as_view(),
        name='additional_entity_1_autocomplete'),
    url(r'^additional_entity_2_autocomplete/$', base.views.learning_units.update.AdditionnalEntity2Autocomplete.as_view(),
