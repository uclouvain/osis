...
class TestDetachEducationGroupYearStrategy(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.master_120_didactic = GroupFactory(education_group_type__name=TrainingType.MASTER_MD_120.name)
        GroupElementYearFactory(parent=cls.finality_group, child_branch=cls.master_120_didactic)
    ...
    def test_is_not_valid_case_detach_group_which_contains_option_which_are_within_finality_master_120(self):
        """
        In this test, we ensure that we CANNOT detach a groups which contains options at 2m level because
