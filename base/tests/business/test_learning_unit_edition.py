...
class TestModifyLearningUnit(TestCase, LearningUnitsMixin):
    ...
    def setUpTestData(cls):
        super().setUpTestData()
        super().setup_academic_years()
        cls.learning_container_year = LearningContainerYearFactory(academic_year=cls.starting_academic_year)
        cls.learning_unit_year = LearningUnitYearFactory(learning_container_year=cls.learning_container_year,
...
class TestUpdateLearningUnitEntities(TestCase, LearningUnitsMixin):
    ...
    def setUpTestData(cls):
        ...
        cls.learning_component_year = LearningComponentYearFactory(
    ...
    def test_with_all_entities_to_update(self):
        ...
        self.assert_entity_has_been_modified(
            ...
            a_new_additional_entity_1,
            ADDITIONAL_REQUIREMENT_ENTITY_1
        )
        self.assert_entity_has_been_modified(
            self.learning_container_year,
            a_new_additional_entity_2,
    ...
    def test_apply_changes_to_next_learning_unit_year(self):
        ...
        for luy in learning_unit_years[1:]:
            self.assert_entity_has_been_modified(
                ...
                a_new_requirement_entity, REQUIREMENT_ENTITY
            )
