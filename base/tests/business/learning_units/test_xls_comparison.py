...
class TestComparisonXls(TestCase):
    ...
    def test_prepare_xls_content_with_data(self):
        ...
        self.assertEqual(data[0][25], _('Yes') if learning_unit_yr.learning_container_year.is_vacant else _('No'))
        self.assertEqual(data[0][26], learning_unit_yr.learning_container_year.get_type_declaration_vacant_display())
        self.assertEqual(data[0][27], learning_unit_yr.get_attribution_procedure_display())
