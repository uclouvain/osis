...
class TestBuildPDFTree(TestCase):
    def setUp(self):
        ...
        self.learning_component_year_1 = LearningComponentYearFactory(
            learning_unit_year__learning_container_year=self.learning_unit_year_1.learning_container_year,
            type=LECTURING
        )
        ...
        self.learning_component_year_3 = LearningComponentYearFactory(
            learning_unit_year__learning_container_year=self.learning_unit_year_2.learning_container_year,
            type=LECTURING
        )
        ...
        self.learning_component_year_5 = LearningComponentYearFactory(
            learning_unit_year__learning_container_year=self.learning_unit_year_3.learning_container_year,
            type=LECTURING
        )
        ...
        self.learning_component_year_7 = LearningComponentYearFactory(
            learning_unit_year__learning_container_year=self.learning_unit_year_4.learning_container_year,
            type=LECTURING
        )
