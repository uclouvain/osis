# Generated by Django 2.2.5 on 2019-12-14 03:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_calendar', models.ForeignKey(on_delete=models.deletion.CASCADE, to='base.AcademicCalendar')),
        ...
        migrations.AddField(
            model_name='proposallearningunit',
            name='entity',
            field=models.ForeignKey(default=2, on_delete=models.deletion.CASCADE, to='base.Entity'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='proposallearningunit',
        ...
        migrations.AddField(
            model_name='proposallearningunit',
            name='learning_unit_year',
            field=models.OneToOneField(on_delete=models.deletion.CASCADE, to='base.LearningUnitYear'),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('learning_unit_year', models.ForeignKey(on_delete=models.deletion.CASCADE, to='base.LearningUnitYear')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('learning_unit_year', models.ForeignKey(on_delete=models.deletion.CASCADE, to='base.LearningUnitYear')),
                ('language', models.ForeignKey(default='', on_delete=models.deletion.CASCADE, to='reference.Language')),
                ('changed', models.DateTimeField(auto_now=True, null=True)),
                ('external_id', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
        ...
        migrations.AlterField(
            model_name='learningcontaineryear',
            name='campus',
            field=models.ForeignKey(null=True, on_delete=models.deletion.CASCADE, to='base.Campus'),
        ),
        migrations.AlterField(
            model_name='learningcontaineryear',
            name='language',
            field=models.ForeignKey(null=True, on_delete=models.deletion.CASCADE, to='reference.Language'),
        ),
        migrations.RemoveField(
            model_name='learningunit',
            name='acronym',
        ...
        migrations.AlterField(
            model_name='learningcontaineryear',
            name='language',
            field=models.ForeignKey(null=True, on_delete=models.deletion.CASCADE, to='reference.Language', verbose_name='language'),
        ),
        migrations.AlterField(
            model_name='learningunit',
            name='faculty_remark',
        ...
        migrations.AlterField(
            model_name='learningunityear',
            name='academic_year',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE, to='base.AcademicYear', validators=[base.models.learning_unit_year.academic_year_validator], verbose_name='academic_year'),
        ),
        migrations.AlterField(
            model_name='learningunityear',
            name='acronym',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=models.deletion.CASCADE, to='base.EducationGroupYear'),
        ),
        migrations.RemoveField(
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(null=True, on_delete=models.deletion.CASCADE, to='base.LearningContainerYear'),
        ),
        migrations.AlterModelManagers(
            name='learningunityear',
            managers=[
                ('objects_with_container', models.manager.Manager()),
            ],
        ),
        migrations.RemoveField(
            model_name='learningcontaineryear',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requesting_entity', models.ForeignKey(on_delete=models.deletion.CASCADE, to='base.Entity', verbose_name='requesting_entity')),
                ('learning_unit_year', models.OneToOneField(on_delete=models.deletion.CASCADE, to='base.LearningUnitYear')),
                ('author', models.ForeignKey(null=True, on_delete=models.deletion.CASCADE, to='base.Person')),
        ...
        migrations.AlterField(
            model_name='educationgroupyear',
            name='academic_year',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE, to='base.AcademicYear', verbose_name='validity'),
        ),
        migrations.AlterField(
            model_name='educationgroupyear',
            name='acronym',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE, to='base.EducationGroupType', verbose_name='training_type'),
        ),
        migrations.AlterField(
            model_name='educationgroupyear',
            name='enrollment_campus',
            field=models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE, related_name='enrollment', to='base.Campus', verbose_name='enrollment_campus'),
        ),
        migrations.AlterField(
            model_name='educationgroupyear',
            name='main_teaching_campus',
            field=models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE, related_name='teaching', to='base.Campus', verbose_name='learning_location'),
        ),
        migrations.AlterField(
            model_name='educationgroupyear',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_group_year', models.OneToOneField(on_delete=models.deletion.CASCADE, to='base.EducationGroupYear')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admission_condition', models.ForeignKey(on_delete=models.deletion.CASCADE, to='base.AdmissionCondition')),
            ],
        ),
        migrations.AddField(
            model_name='educationgroupyear',
            name='administration_entity',
            field=models.ForeignKey(null=True, on_delete=models.deletion.CASCADE, related_name='administration_entity', to='base.Entity', verbose_name='administration_entity'),
        ),
        migrations.AddField(
            model_name='educationgroupyear',
            name='management_entity',
            field=models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE, related_name='management_entity', to='base.Entity', verbose_name='management_entity'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('child_type', models.ForeignKey(on_delete=models.deletion.CASCADE, related_name='unauthorized_child_type', to='base.EducationGroupType')),
                ('parent_type', models.ForeignKey(on_delete=models.deletion.CASCADE, related_name='unauthorized_parent_type', to='base.EducationGroupType')),
            ],
        ),
        migrations.RunSQL(
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE, to='reference.Language', verbose_name='primary_language'),
        ),
        migrations.AlterField(
            model_name='educationgroupyear',
            name='schedule_type',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_id', models.CharField(blank=True, max_length=100, null=True)),
                ('changed', models.DateTimeField(auto_now=True, null=True)),
                ('domain', models.ForeignKey(on_delete=models.deletion.CASCADE, to='reference.Domain')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('changed', models.DateTimeField(auto_now=True)),
                ('child_type', models.ForeignKey(on_delete=models.deletion.CASCADE, related_name='authorized_child_type', to='base.EducationGroupType')),
                ('parent_type', models.ForeignKey(on_delete=models.deletion.CASCADE, related_name='authorized_parent_type', to='base.EducationGroupType')),
            ],
        ),
        migrations.DeleteModel(
            name='UnauthorizedRelationship',
        ...
        migrations.AlterField(
            model_name='groupelementyear',
            name='parent',
            field=models.ForeignKey(null=True, on_delete=models.deletion.CASCADE, related_name='parents', to='base.EducationGroupYear'),
        ),
        migrations.AlterField(
            model_name='offerenrollment',
            name='education_group_year',
            field=models.ForeignKey(null=True, on_delete=models.deletion.PROTECT, to='base.EducationGroupYear'),
        ),
        migrations.AlterField(
            model_name='educationgroupyear',
            name='duration_unit',
        ...
        migrations.AlterField(
            model_name='educationgroupyear',
            name='education_group_type',
            field=models.ForeignKey(null=True, on_delete=models.deletion.CASCADE, to='base.EducationGroupType', verbose_name='training_type'),
        ),
        migrations.AlterField(
            model_name='groupelementyear',
            name='comment',
        ...
        migrations.AddField(
            model_name='educationgroupyear',
            name='main_domain',
            field=models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE, to='reference.Domain', verbose_name='main domain'),
        ),
        migrations.AddField(
            model_name='educationgroupyear',
