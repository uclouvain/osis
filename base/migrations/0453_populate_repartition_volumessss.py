...
# def populate_repartition_volumes(apps, schema_editor):
#     # create group
#     EntityComponentYear = apps.get_model('base', 'EntityComponentYear')
#     LearningComponentYear = apps.get_model('base', 'LearningComponentYear')
#     LearningComponentYear.objects.all()
#
#     """"""
