# Generated by Django 2.2.13 on 2021-01-07 09:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('base', '0550_remove_learningcontaineryear_in_charge in base'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(choices=[
                ...
                ('SCORES_EXAM_DIFFUSION', 'Scores exam diffusion'),
                ...
                ('CONTINUING_EDUCATION_ACADEMIC_YEAR_LINKABLE_TO_ADMISSION',
                 'Continuing education academic year linkable to admission'),
                ('TESTING', 'Testing'), ('RELEASE', 'Release')
            ], max_length=70),
        ),
    ]
