...
class EducationGroup(SerializableModel):
    ...
    class Meta:
        permissions = (
            ...
            ("change_commonpedagogyinformation", "Can change common pedagogy information"), # OLD: can_edit_common_education_group
            ("change_pedagogyinformation", "Can change pedagogy information"),  # OLD: can_edit_educationgroup_pedagogy
        )
