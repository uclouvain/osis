...
class AuthorizedRelationship(models.Model):
    ...
    min_count_authorized = models.CharField(max_length=5, choices=MIN_COUNT_CONSTRAINTS, default=_("Zero"))
    max_count_authorized = models.CharField(max_length=5, choices=MAX_COUNT_CONSTRAINTS, default=_("Many"))
