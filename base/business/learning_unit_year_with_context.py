...
def volume_from_initial_learning_component_year(learning_component_year, repartition_volumes):
    return {
        ...
        VOLUME_REQUIREMENT_ENTITY: Decimal(repartition_volumes.get(VOLUME_REQUIREMENT_ENTITY) or 0),
        ...
        VOLUME_ADDITIONAL_REQUIREMENT_ENTITY_2: Decimal(repartition_volumes.get(VOLUME_ADDITIONAL_REQUIREMENT_ENTITY_2)
                                                        or 0),
        VOLUME_GLOBAL: sum([Decimal(repartition_volumes.get(VOLUME_REQUIREMENT_ENTITY) or 0),
                            Decimal(repartition_volumes.get(VOLUME_ADDITIONAL_REQUIREMENT_ENTITY_1) or 0),
                            Decimal(repartition_volumes.get(VOLUME_ADDITIONAL_REQUIREMENT_ENTITY_2) or 0)])
    }
