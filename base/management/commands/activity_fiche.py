...
class Command(BaseCommand):
    def handle(self, *args, **options):
        template_url = "https://epc.uclouvain.be/WebApi/resources/FicheActivite/code/{acronym}/{academic_year__year}"
        headers = {'Authorization': 'Basic cG9ydGFpbDomRjFuWmVyYg=='}
        scan_list = LearningUnitYear.objects.filter(acronym__icontains='L', academic_year__year=2019).values('acronym', 'academic_year__year')[:100]
        ...
        with open('result_flood.csv', mode='w') as csv_file:
