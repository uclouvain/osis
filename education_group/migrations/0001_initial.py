# Generated by Django 2.2.5 on 2019-12-16 11:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_year', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='group_end_years', to='base.AcademicYear', verbose_name='Last year of organization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_fr_ISO_639_1', models.CharField(max_length=255, verbose_name='Title in French')),
                ('title_en_ISO_639_1', models.CharField(blank=True, default='', max_length=240, verbose_name='Title in English')),
                ('remark_fr', models.TextField(blank=True, default='', verbose_name='remark')),
                ('remark_english_en', models.TextField(blank=True, default='', verbose_name='remark in english')),
