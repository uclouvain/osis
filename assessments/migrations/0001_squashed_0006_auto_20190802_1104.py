# Generated by Django 2.2.5 on 2019-12-14 01:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE, to='reference.Country')),
                ('offer_year', models.OneToOneField(on_delete=models.deletion.CASCADE, to='base.OfferYear')),
            ],
        ),
